...
for($i=0;$i<$countF;$i++)
{
    //|| ( $_SESSION['idprod'] == $prestigeFerraille[$i][0])
    if(isset($_POST["".$prestigeFerraille[$i][0].""]) )  
    {
        echo "<div class=\"produit$\" style=\"background-color:#e6e6fa\">
                <table><tr>
                    <td><div style=\"height:300px;width:250\">
                            <img class=\"img-thumbnail\" src=\"".utf8_encode($prestigeFerraille[$i][7])."\" style=\"height:300px;width:250px\">
                        </div></td>
                            <td width=\"2000px\"><div><h4 style=\"text-align:center;weight:500px\" >".utf8_encode($prestigeFerraille[$i][1])."</h4>
                                    <p ><strong slyle=\"\">Prix: </strong>".utf8_encode($prestigeFerraille[$i][3]).".00 euros<br><br>".utf8_encode($prestigeFerraille[$i][2])."</p>
                                </div></td>
                    <td>
                        <div style=\"border:1px solid #6495ed;height:250px;width:250px;background-color:#EFF6FF;border-radius: 10px;\">
                                <p><strong slyle=\"\">Prix: </strong>".utf8_encode($prestigeFerraille[$i][3]).".00 euros</p><br>
                                <p><strong slyle=\"\">Fraix de Livraison: </strong> Aucun</p>
                                <form action=\"#\" method=\"post\" style=\"float:bottom-left\">
                                  <button style=\"background-color:#008080;text-align: center;color: #fff\"type=\"submit\" name=\"".$prestigeFerraille[$i][0]."\" value=\"".$prestigeFerraille[$i][0]."\">Acheter</button>
                                </form>
                                <form action=\"panier.php\" method=\"post\" style=\"float:bottom-left\">
                                  <button style=\"background-color:#008080;text-align: center;;color: #fff\"type=\"submit\" name=\"".$prestigeFerraille[$i][0]."\" value=\"".$prestigeFerraille[$i][0]."\">Ajouter Panier</button>
                                </form>
                        </div>
                    </td>
                        </tr>
        ...
        <table style=\"border:3px solid #6495ed;border-collapse:collapse;width:90%;margin:auto;\">
        <tbody style=\"background-color:#FFFFFF;border:1px solid #6495ed;\">
            <tr>
                <th style=\"font-family:monospace;border:1px dotted #6495ed;padding:5px;background-color:#EFF6FF;width:25%;\">Qualite</th>
                <td style=\"width:32px\"></td>
                <td>".utf8_encode($prestigeFerraille[$i][5])."</td>
            </tr>
            <tr>
                <th style=\"font-family:monospace;border:1px dotted #6495ed;padding:5px;background-color:#EFF6FF;width:25%;\">Default</th>
                <td style=\"width:32px\"></td>
                <td>".utf8_encode($prestigeFerraille[$i][6])."</td><br>
            </tr>
            <tr>
                <th style=\"font-family:monospace;border:1px dotted #6495ed;padding:5px;background-color:#EFF6FF;width:25%;\">Nom</th>
                <td style=\"width:32px\"></td>
                <td>".utf8_encode($prestigeFerraille[$i][8])."</td><br>
            </tr>
            <tr>
                <th style=\"font-family:monospace;border:1px dotted #6495ed;padding:5px;background-color:#EFF6FF;width:25%;\">Prenom</th>
                <td style=\"width:32px\"></td>
                <td>".utf8_encode($prestigeFerraille[$i][9])."</td><br>
            </tr>
            <tr>
                <th style=\"font-family:monospace;border:1px dotted #6495ed;padding:5px;background-color:#EFF6FF;width:25%;\">Email</th>
                <td style=\"width:32px\"></td>
                <td>".utf8_encode($prestigeFerraille[$i][10])."</td><br>
            </tr>
            <tr>
                <th style=\"font-family:monospace;border:1px dotted #6495ed;padding:5px;background-color:#EFF6FF;width:25%;\">Telephone</th>
                <td style=\"width:32px\"></td>
                <td>+33 ".utf8_encode($prestigeFerraille[$i][11])."</td><br>
            </tr>
        </tbody>
       </table>";
    }
...
for($i=0;$i<$countV;$i++)
{
    if(isset($_POST["".$prestigeVIP[$i][0].""]) )
    {
        echo "<div class=\"produit$\" style=\"background-color:#e6e6fa\">
                <table><tr>
                    <td><div style=\"height:300px;width:250\">
                            <img class=\"img-thumbnail\" src=\"".utf8_encode($prestigeVIP[$i][7])."\" style=\"height:300px;width:250px\">
                        </div></td>
                            <td width=\"2000px\"><div><h4 style=\"text-align:center;weight:500px\" >".utf8_encode($prestigeVIP[$i][1])."</h4>
                                    <p ><strong slyle=\"\">Prix: </strong>".utf8_encode($prestigeVIP[$i][3]).".00 euros<br><br>".utf8_encode($prestigeVIP[$i][2])."</p>
                                </div></td>
                    <td>
                        <div style=\"border:1px solid #6495ed;height:250px;width:250px;background-color:#EFF6FF;border-radius: 10px;\">
                                <p><strong slyle=\"\">Prix: </strong>".utf8_encode($prestigeVIP[$i][3]).".00 euros</p><br>
                                <p><strong slyle=\"\">Fraix de Livraison: </strong> Aucun</p>
                                <form action=\"#\" method=\"post\" style=\"float:bottom-left\">
                                  <button style=\"background-color:#008080;text-align: center;color: #fff\"type=\"submit\" name=\"".$prestigeVIP[$i][0]."\" value=\"".$prestigeVIP[$i][0]."\">Acheter</button>
                                </form>
                                <form action=\"panier.php\" method=\"post\" style=\"float:bottom-left\">
                                  <button style=\"background-color:#008080;text-align: center;;color: #fff\"type=\"submit\" name=\"".$prestigeVIP[$i][0]."\" value=\"".$prestigeVIP[$i][0]."\">Ajouter Panier</button>
                                </form>
                        </div>
                    </td>
                        </tr>
        ...
        <tbody style=\"background-color:#FFFFFF;border:1px solid #6495ed;\">
            <tr>
                <th style=\"font-family:monospace;border:1px dotted #6495ed;padding:5px;background-color:#EFF6FF;width:25%;\">Qualite</th>
                <td style=\"width:32px\"></td>
                <td>".utf8_encode($prestigeVIP[$i][5])."</td>
            </tr>
            <tr>
                <th style=\"font-family:monospace;border:1px dotted #6495ed;padding:5px;background-color:#EFF6FF;width:25%;\">Default</th>
                <td style=\"width:32px\"></td>
                <td>".utf8_encode($prestigeVIP[$i][6])."</td><br>
            </tr>
            <tr>
                <th style=\"font-family:monospace;border:1px dotted #6495ed;padding:5px;background-color:#EFF6FF;width:25%;\">Nom</th>
                <td style=\"width:32px\"></td>
                <td>".utf8_encode($prestigeVIP[$i][8])."</td><br>
            </tr>
            <tr>
                <th style=\"font-family:monospace;border:1px dotted #6495ed;padding:5px;background-color:#EFF6FF;width:25%;\">Prenom</th>
                <td style=\"width:32px\"></td>
                <td>".utf8_encode($prestigeVIP[$i][9])."</td><br>
            </tr>
            <tr>
                <th style=\"font-family:monospace;border:1px dotted #6495ed;padding:5px;background-color:#EFF6FF;width:25%;\">Email</th>
                <td style=\"width:32px\"></td>
                <td>".utf8_encode($prestigeVIP[$i][10])."</td><br>
            </tr>
            <tr>
                <th style=\"font-family:monospace;border:1px dotted #6495ed;padding:5px;background-color:#EFF6FF;width:25%;\">Telephone</th>
                <td style=\"width:32px\"></td>
                <td>+33 ".utf8_encode($prestigeVIP[$i][11])."</td><br>
            </tr>
        </tbody>
       </table>";
    }
    ...
    if(isset($_POST["".$prestigeMusee[$i][0].""]) )
    {
                ...
                <table><tr>
                    <td><div style=\"height:300px;width:250\">
                            ...
                            <td width=\"2000px\"><div><h4 style=\"text-align:center;weight:500px\" >".utf8_encode($prestigeMusee[$i][1])."</h4>
                                    <p ><strong slyle=\"\">Prix: </strong>".utf8_encode($prestigeMusee[$i][3]).".00 euros<br><br>".utf8_encode($prestigeMusee[$i][2])."</p>
                                </div></td>
                    <td>
                        <div style=\"border:1px solid #6495ed;height:250px;width:250px;background-color:#EFF6FF;border-radius: 10px;\">
                                <p><strong slyle=\"\">Prix: </strong>".utf8_encode($prestigeMusee[$i][3]).".00 euros</p><br>
                                <p><strong slyle=\"\">Fraix de Livraison: </strong> Aucun</p>
                                <form action=\"#\" method=\"post\" style=\"float:bottom-left\">
                                <button style=\"background-color:#008080;text-align: center;color: #fff\"type=\"submit\" name=\"".$prestigeMusee[$i][0]."\" value=\"".$prestigeMusee[$i][0]."\">Acheter</button>
                              </form>
                              <form action=\"panier.php\" method=\"post\" style=\"float:bottom-left\">
                                <button style=\"background-color:#008080;text-align: center;;color: #fff\"type=\"submit\" name=\"".$prestigeMusee[$i][0]."\" value=\"".$prestigeMusee[$i][0]."\">Ajouter Panier</button>
                              </form>
                        </div>
                    </td>
                        </tr>
        ...
        <tbody style=\"background-color:#FFFFFF;border:1px solid #6495ed;\">
            <tr>
                <th style=\"font-family:monospace;border:1px dotted #6495ed;padding:5px;background-color:#EFF6FF;width:25%;\">Qualite</th>
                <td style=\"width:32px\"></td>
                <td>".utf8_encode($prestigeMusee[$i][5])."</td>
            </tr>
            <tr>
                <th style=\"font-family:monospace;border:1px dotted #6495ed;padding:5px;background-color:#EFF6FF;width:25%;\">Default</th>
                <td style=\"width:32px\"></td>
                <td>".utf8_encode($prestigeMusee[$i][6])."</td><br>
            </tr>
            <tr>
                <th style=\"font-family:monospace;border:1px dotted #6495ed;padding:5px;background-color:#EFF6FF;width:25%;\">Nom</th>
                <td style=\"width:32px\"></td>
                <td>".utf8_encode($prestigeMusee[$i][8])."</td><br>
            </tr>
            <tr>
                <th style=\"font-family:monospace;border:1px dotted #6495ed;padding:5px;background-color:#EFF6FF;width:25%;\">Prenom</th>
                <td style=\"width:32px\"></td>
                <td>".utf8_encode($prestigeMusee[$i][9])."</td><br>
            </tr>
            <tr>
                <th style=\"font-family:monospace;border:1px dotted #6495ed;padding:5px;background-color:#EFF6FF;width:25%;\">Email</th>
                <td style=\"width:32px\"></td>
                <td>".utf8_encode($prestigeMusee[$i][10])."</td><br>
            </tr>
            <tr>
                <th style=\"font-family:monospace;border:1px dotted #6495ed;padding:5px;background-color:#EFF6FF;width:25%;\">Telephone</th>
                <td style=\"width:32px\"></td>
                <td>+33 ".utf8_encode($prestigeMusee[$i][11])."</td><br>
            </tr>
        </tbody>
       </table>";
    }
