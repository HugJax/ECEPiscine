<?php
    ...
    $requete = "SELECT count(*) FROM produit WHERE Categorie='Ferraille ou tresor' ";
    ...
    $w=0;
    if($db_found) {
        $sql3="SELECT IDproduit,Nom,Description,Prix,Categorie,Qualite,Defaut,OffreSpeciale,IDutilisateur FROM produit WHERE Categorie='Ferraille ou tresor' ORDER BY DateMiseEnLigne DESC;";
