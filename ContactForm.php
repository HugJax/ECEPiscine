...
<html>
    <head>
        ...
        <title>eBay ECE :: Nous contacter</title>
        <meta charset="UTF-8">
    ...
    <body>
        ...
        <section id="contact">
			<div class="section-content">
				<h1 class="section-header" style="text-align:center"><span class="content-header wow fadeIn " data-wow-delay="0.2s" data-wow-duration="2s">Envoyez-nous vos messages</span></h1>
				<h3 style="text-align:center">Une demande ? Une requête ? Notre form contact est là pour ça !</h3>
			</div>
				...
				<form>
					<div class="col-md-6 form-line">
			  			<div class="form-group">
					    	...
					    	<input type="text" class="form-control" id="" placeholder=" Entrer Nom">
				  		</div>
				  		<div class="form-group">
					    	<label for="exampleInputEmail">Email Address</label>
					    	<input type="email" class="form-control" id="exampleInputEmail" placeholder=" Entrer Email id">
					  	</div>	
					  	<div class="form-group">
					    	<label for="telephone">Mobile No.</label>
					    	<input type="tel" class="form-control" id="telephone" placeholder=" Entrer 10-digit mobile no.">
			  			</div>
			  		</div>
			  		<div class="col-md-6">
			  			<div class="form-group">
